...
// Query: *[_type == "product" && slug.current == $slug] [0] {    content[]{    ...,    markDefs[]{      ...,        link {      ...,      _type == "link" => {        "page": page->slug.current,        "post": post->slug.current        }      }    }  },      _id,  "status": select(_originalId in path("drafts.**") => "draft", "published"),  "name": name,  "slug": slug.current,  brand,  price,  image,  }
...
export type ProductPagesSlugsResult = Array<{
  slug: string;
}>;
// Variable: pagesSlugs
